  ...
  useEffect(() => {
    ...
    const fetchUser = async () => {
      const response = await axios.get(
        `http://localhost:4824/combinedData/${id}`,
        {
  ...
  const handleUpdate = async () => {
    ...
    try {
      const response = await axios.put(
        `http://localhost:4824/combinedData/${user.Id}`,
        { ...user, Permissions: permissions },
        {
          // const response = await axios.put(
          //   `${apiUrlCinema}/combinedData/${user.Id}`,
          //   { ...user, Permissions: permissions },
          //   {
          headers: { "x-access-token": token },
        }
      ...
      >
        ...
        <FormControlLabel
          control={
            <Checkbox
              ...
              checked={permissions["View Subscriptions"]}
        ...
        <FormControlLabel
          control={
            <Checkbox
              ...
              checked={permissions["Create Subscriptions"]}
              onChange={handleCheckboxChange}
            />
          }
        ...
        <FormControlLabel
          control={
            <Checkbox
              ...
              checked={permissions["Delete Subscriptions"]}
              onChange={handleCheckboxChange}
            />
          }
        ...
        <FormControlLabel
          control={
            <Checkbox
              ...
              checked={permissions["Update Subscriptions"]}
              onChange={handleCheckboxChange}
            />
          }
        ...
        <FormControlLabel
          control={
            <Checkbox
              name="View Movies"
              checked={permissions["View Movies"]}
              onChange={handleCheckboxChange}
            />
          }
          label="View Movies"
        ...
        <FormControlLabel
          control={
            <Checkbox
              name="Create Movies"
              checked={permissions["Create Movies"]}
              onChange={handleCheckboxChange}
            />
          }
          label="Create Movies"
        ...
        <FormControlLabel
          control={
            <Checkbox
              name="Delete Movies"
              checked={permissions["Delete Movies"]}
              onChange={handleCheckboxChange}
            />
          }
          label="Delete Movies"
        ...
        <FormControlLabel
          control={
            <Checkbox
              name="Update Movies"
              checked={permissions["Update Movies"]}
              onChange={handleCheckboxChange}
            />
          }
          label="Update Movie"
